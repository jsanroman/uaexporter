...
class Report:
    ...
    def load_data(self, page, start_date, end_date):
    ...
    def refresh_pagination(self, start_date=None, end_date=None):
        self.data = self.ua_connector.get_data(self.config, start_date, end_date)
